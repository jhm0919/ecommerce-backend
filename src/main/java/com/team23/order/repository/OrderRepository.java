package com.team23.order.repository;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("""
            ...
            FROM Order o
            WHERE o.status IN (
                com.team23.order.domain.OrderStatus.PENDING,
                com.team23.order.domain.OrderStatus.CONFIRMED
            )
    ...
    @Query("""
        SELECT FUNCTION('DATE', o.createdAt) AS orderDate,
               ...
               COUNT(o)
        FROM Order o
        WHERE o.status = com.team23.order.domain.OrderStatus.CANCELLED
          AND o.createdAt >= :from AND o.createdAt < :to
        GROUP BY FUNCTION('DATE', o.createdAt)
        ORDER BY orderDate ASC
        """)
